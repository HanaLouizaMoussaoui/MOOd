...
@Composable
fun UserAccountScreen(contentPadding: PaddingValues, moodViewModel: MoodViewModel, navController: NavHostController, onThemeSelect: (String) -> Unit) {
    Box(
            ...
            .background(MaterialTheme.colorScheme.background))
        {
            Column(
                ...
                UserAccount(onThemeSelect, moodViewModel)
            }
